...
#ifdef CONFIG_AUTO_DNLD
    //TODO add magic char 'L' to header file
    printk("Notify FW to start...\n");
...
static int __init bl_mod_init(void)
{
    ...
    //BL_DBG_MOD_LEVEL(BL_FN_ENTRY_STR);
	//BL_DBG_MOD_LEVEL(D_ERR D_PHY "just for test mod and level print\n");
	//BL_DBG_MOD_LEVEL(D_ERR D_PHY "print i=%d\n", i);
	//BL_DBG_MOD_LEVEL(D_ERR "only have D_ERR\n");
	//BL_DBG_MOD_LEVEL(D_PHY "only have D_PHY\n");
	//BL_DBG_MOD_LEVEL("have nothing\n");
